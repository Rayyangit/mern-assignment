...
const TransactionTable = ({
  ...
  return (
    <div className="m-5">
      <div className="overflow-x-auto flex flex-col container max-w-max bg-[#c6c3b9] rounded-xl my-10">
        <div className="sm:-mx-6 lg:-mx-8">
          <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
            <div className="overflow-hidden">
              <table className="min-w-full text-center bg-[#76b487]"> {/* Light blue background */}
